...
% IMPORTANT: Compilar usando Xelatex.
...
% {
%   \setbeamertemplate{background}{\includegraphics[width=\paperwidth]{config/background-quadrados-gradiente-preto.png}}
% 
%   \begin{frame}[plain]
%     \titlepage
%   \end{frame}
...
\begin{frame}{Linha do tempo da Visualização de Dados}
  ...
  \begin{figure}[h]
    \centering
    % \hspace*{-0.5em}
    \includegraphics[height=5.5cm]{img/timeline_dataviz.pdf}
