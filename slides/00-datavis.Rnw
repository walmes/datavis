...
\begin{frame}{Objetivos}
  ...
  \item Fundamentos de visualiação de dados.
    \begin{itemize}
    \item Tipo de visualiação.
...
\begin{frame}{O que vimos até aqui}
  ...
  A história da visualização de dados:
  \begin{itemize}
  \item Fase 1: As contribuições pontuais.
  \item Fase 2: Os manuais/livros.
  \item Fase 3: Os estudos aprofundados.
  \item Fase 4: A informatização.
  \item Fase 5: Hoje $\rightarrow$ volume, velocidade, variedade: Big
    Data.
  \end{itemize}
...
\begin{frame}{Definição}
    ...
    \begin{block}{\Large Visualização de dados}
      ...
      A representação e apresentação de dados que exploram nossa
      habilidade de percepção visual com a finalidade de aumentar a
      compreensão \cite{kirk2012data}.
    \end{block}
...
\begin{frame}{Aspectos da definição}
  ...
  \item \hi{Apresentação}: como comunicar-se com a visualização.
...
\begin{frame}[allowframebreaks]{Visualização conceitual}
  ...
  \begin{figure}[h]
    ...
    \caption{Ilustração conceitual do processo de correção de manuscrito
      para submissão entre orientado e orientador. Fonte:
  ...
  \begin{figure}[h]
    ...
    \caption{Ilustração conceitual do sentimento de ser confundido com
      um aluno de doutorado em diferentes fases da vida
      acadêmica. Fonte: \href{http://phdcomics.com}{phdcomics.com}.}
  \end{figure}
  ...
  \begin{figure}[h]
    ...
    \caption{Ilustração baseada em diagramas de Venn sobre a composição
      de habilidades de um profissional de um cientista de dados (esq.)
      e o fluxo de ações de tarefas em ciência de dados. Fonte: o
      autor. Visite \url{https://github.com/walmes/Tikz}.}
  \end{figure}
...
\begin{frame}[allowframebreaks]{Os 8 chapéus da visualização de dados}
  ...
  \begin{figure}
    ...
    \caption{Os 8 ``chapeús'' de Kirk ilustrando as diferentes
      competências e papeis em visualização de dados. Fonte dos ícones:
